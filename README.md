...
* [x] User can delete tweets (only tweets he made) by long clicking on it.
...
- Working a lot with API requests and reading documentation to learn how to use it.
- Using more complicated JSONs.
